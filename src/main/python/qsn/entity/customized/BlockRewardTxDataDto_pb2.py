...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='qsn/entity/customized/BlockRewardTxDataDto.proto',
...
_BLOCKREWARDTXDATADTO = _descriptor.Descriptor(
  name='BlockRewardTxDataDto',
  full_name='org.qsn.protobuf.BlockRewardTxDataDto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='blockReward', full_name='org.qsn.protobuf.BlockRewardTxDataDto.blockReward', index=0,
